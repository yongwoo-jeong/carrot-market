      ...
      <div className="mt-8">
          ...
          <div className="mt-2">
            {method === "email" ? (
              <input
                ...
                appearance-none rounded-md border-gray-300 py-3 placeholder-gray-400 shadow-sm focus:border-orange-500 focus:outline-none focus:ring-orange-500"
                required
              />
            ) : null}
            {method === "phone" ? (
              <div className="flex rounded-md shadow-sm">
                <span className="flex select-none items-center justify-center rounded-l-md border border-r-0  border-gray-300 bg-gray-50 px-4 text-sm text-gray-500">
                  +82
                </span>
                <input
                  type="number"
                  className="py- focus: w-full 
                appearance-none rounded-md rounded-l-none border-gray-300 py-3 placeholder-gray-400 shadow-sm focus:border-orange-500 focus:outline-none focus:ring-orange-500"
                  required
                />
              </div>
            ) : null}
        ...
        <div className="mt-8">
          <div className="relative">
            <div className="absoulte w-full border-t border-gray-300" />
