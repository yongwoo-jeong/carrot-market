  ...
  return (
    <div className="bg-slate-400 py-20 px-20 grid gap-10 lg:grid-cols-2 xl:grid-cols-3 xl:place-content-center min-h-screen">
      <div className="bg-white p-6 rounded-3xl shadow-2xl">
        ...
        <button
          className="mt-5 bg-blue-500 text-white p-3 text-center rounded-xl w-1/2 mx-auto block
        ...
        <div className="flex flex-col">
          ...
          <div className="mt-3 mb-5 flex justify-between items-center">
            <div className="space-x-2">
              ...
              <button className="w-5 h-5 rounded-full bg-indigo-500 focus:ring-2 ring-indigo-500 ring-offset-2 transition" />
              <button className="w-5 h-5 rounded-full bg-teal-500 focus:ring-2 ring-teal-500 ring-offset-2 transition" />
            </div>
