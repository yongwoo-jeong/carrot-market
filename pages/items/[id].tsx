...
const ItemDetail: NextPage = () => {
  return (
    <div className="px-4 py-10">
      <div className="mb-8">
        ...
        <div className="mt-5">
          ...
          <div className="flex items-center justify-between space-x-2">
            ...
            <button className="flex items-center justify-center rounded-md p-3 py-3 text-gray-400 hover:bg-gray-100 hover:text-gray-500">
              <svg
                className="h-6 w-6 "
      ...
      <div>
        <h2 className="text-gray-90000 text-2xl font-bold">Similar items</h2>
