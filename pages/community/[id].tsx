...
const CommunityPostDetail: NextPage = () => {
  return (
    <div>
      <span className="my-2.5 ml-4 inline-flex items-center rounded-full bg-gray-100 px-2.5 text-xs font-medium text-gray-800">
        동네질문
      </span>
      ...
      <div className="my-5 space-y-4 px-4">
        <div className="flex items-start space-x-3">
          ...
          <div>
            ...
            <span className="block to-gray-500 text-xs">2 시간 전</span>
